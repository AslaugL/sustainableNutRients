...
standardiseRedMeatnSubs <- function(df) {
  ...
  df  %>%
    ...
    mutate(Ingredients_standardised = case_when(
      ...
      str_detect(Ingredients, 'bacon|lettsaltet sideflesk|lardons') & str_detect(Ingredients, 'gold\\b|swear') ~ 'bacon rinds',
      str_detect(Ingredients, 'bacon|lettsaltet sideflesk|lardons') & str_detect(Ingredients, 'fat') ~ 'bacon fat',
      str_detect(Ingredients, 'bacon|lettsaltet sideflesk|lardons') & !str_detect(Ingredients, 'cheese|spread|turkey|sausage|pate|pâté') ~ 'bacon',
      ...
      str_detect(Ingredients, 'beef') & str_detect(Ingredients, 'comb|entre|t-bone') |
        str_detect(Ingredients, 'entrecote|cote de boef|scotch or black welsh beef|standing rib roast, bone in|rib-eye steak|rib eye steak|ribeye steak') & !str_detect(Ingredients, 'venison|reindeer|elk|moose') ~ 'beef rib-eye steak', #Also used for the steak in Steak with potato salad
      str_detect(Ingredients, 'beef|cattle|angus') & str_detect(Ingredients, 'tenderloin|fillet') & !str_detect(Ingredients, 'outer') ~ 'beef tenderloin',
      ...
      str_detect(Ingredients, 'beef|burger') & str_detect(Ingredients, 'brisket|short rib') ~ 'beef brisket',
      ...
      str_detect(Ingredients, 'beef|cattle|\\bangus\\b') & !str_detect(Ingredients, 'fund|broth|stock|bouilljon|bouillion|bouillon|consomme|gravy|tomato|glace') ~ 'beef chuck roll',
      ...
      str_detect(Ingredients, 'venison') ~ 'game beef venison shoulder',
      ...
      str_detect(Ingredients, 'lamb') & str_detect(Ingredients, 'sausage') ~ 'lamb sausage',
      ...
      str_detect(Ingredients, '\\blamb') & !str_detect(Ingredients, 'power|broth|bouillon|stock') ~ 'lamb shoulder', #Default
      ...
      str_detect(Ingredients, 'pork') & str_detect(Ingredients, 'patty|patties') ~ 'pork patty',
