...
standardiseFruitVegS <- function(df){
  df  %>%
    ...
    mutate(Ingredients_standardised = case_when(
      ...
      str_detect(Ingredients, 'lollo rosso|oak leaf') & str_detect(Ingredients, 'green') ~ 'salad lollo rosso green',
      str_detect(Ingredients, 'lollo rosso|oak leaf') ~ 'salad lollo rosso',
